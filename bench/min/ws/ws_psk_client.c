/* Minimal full-wolfSSL TLS 1.3 PSK client, size-only harness (stub I/O + seed).
 * Drives wolfSSL_connect with a PSK callback so --gc-sections keeps the TLS 1.3
...
static unsigned int psk_cb(WOLFSSL* ssl, const char* hint, char* id,
