...
| `WOLFNANO_HAVE_ECDHE_P256` | secp256r1 (0x0017) | **34.5 KB** | FIPS / CNSA, or maximum enterprise interop |
| `WOLFNANO_FIPS` | secp256r1 only | 34.5 KB | approved-mode (also drops X25519/ChaCha/Ed25519 from offers) |
