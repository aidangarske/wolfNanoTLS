...
# ---- wolfNano (minimal config in bench/min/wnc) ----
...
$CC $WN_CF -DWOLFNANO_HAVE_ECDHE_P256 $WN_SUP_P256 $WN_SHELL bench/min/wn_psk_client.c $LINK -o "$OUT/wn_psk_p256.elf" 2>/dev/null
