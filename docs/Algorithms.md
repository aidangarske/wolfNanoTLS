...
|---|---|---|
| `WOLFNANOTLS_X509` | parse cert + verify signature against issuer key | done |
| `WOLFNANOTLS_HAVE_RSA_VERIFY` | RSA-signed chains (up to RSA-4096 roots, e.g. ISRG Root X1) | done |
