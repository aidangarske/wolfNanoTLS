...
/**
 * Minimal wolfNanoTLS TLS 1.3 client: external-PSK + ECDHE handshake, then one
 ...
 * Try it against wolfSSL's example server (its built-in TLS 1.3 PSK):
 *   examples/server/server -v 4 -s -i -p 4433
 */
