/* mbedTLS minimal TLS 1.3 cert server, FED the shared captured ClientHello so the
 * full server handshake links under -flto (a garbage-input stub degenerates).
 * Size-only; mirrors mbed_server.c setup with mbed_psk_server_fed.c fed I/O. */
